...
public class GameManagerCoin : MonoBehaviour
{
    ...
    public TankManagerCoin[] m_Tanks;               // A collection of managers for enabling and disabling different aspects of the tanks.
    public TankManagerCoin win;
    ...
    private TankManagerCoin m_RoundWinner;          // Reference to the winner of the current round.  Used to make an announcement of who won.
    private TankManagerCoin m_GameWinner;           // Reference to the winner of the game.  Used to make an announcement of who won.
    ...
    private void OnGUI()
    {
        ...
        style.fontSize = 40;
        GUI.Label(new Rect(512, 20, 200, 200), time.ToString(), style);
        // GUI.Label(new Rect(20,20,100,20), "SCORE TANK 2 : " + coin2);
    }
    ...
    private TankManagerCoin GetGameWinner()
    {
        // Go through all the tanks...
        for (int i = 0; i < m_Tanks.Length; i++)
        {
